...
```
  ...
  odataURI: "marketprice/Prices?$filter=contains(sub_category_name,'Hdpe')&$orderby=price_point%20asc&%24format=JSON&%24top=10&%24skip=0&%24count=true",
  odataURIv2: "marketprice/Prices?$filter=sub_category_name eq 'Hdpe'&$format=JSON&$top=10&$skip=0&$count=true",
  mappedEntities: {
    filterSubCategoryName: 'sub_category_name',
    pricingOutlook: 'market_outlook',
    datetimeV2: { name: 'actual_period', value: 'not resolved' },
    dateType: 'set',
    sort: 'asc',
